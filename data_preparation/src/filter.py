...
print("before filtering:", len(variation_rate_list))

threshold = np.percentile(variation_rate_list, 90)
print("variation_rate threshold:", threshold)
...
print("after variation_rate filtering:", len(kept["labels"]))


alignment_gap_list = kept["alignment_gap"]
threshold = np.percentile(alignment_gap_list, 90)
print("alignment_gap threshold:", threshold)
...
print("after alignment_gap filtering:", len(kept2["labels"]))
print("filtered:", len(filtered["labels"]))
